...
public class BriansBrain implements ICellAutomaton {
    ...
    /**
     *
     * Construct a Brian's Brain ICellAutomaton using a grid with the given height
     * and width.
     *
     * @param height
     * @param width
    ...
    public Color getColorInCurrentGeneration(int x, int y) {
        if (currentGeneration.get(x, y) == CellState.DYING) {
            return Color.blue;
    ...
    public void stepAutomaton() {
        ...
        IGrid<CellState> nextGeneration = new MyGrid<>(
