...
public class AppInfo {
	 ...
	 */
	public static final String APP_NAME = "Four-in-a-row";
	/**
	 * The main class, for starting the application
	 */
	public static final Class<?> APP_MAIN_CLASS = sem2.inf101.v18.sem2.FourInARow.Main.class; // e.g., inf101.v18.sem2.Main.class
	/**
	 * Your name.
	 */
	public static final String APP_DEVELOPER = "Andrey Belinskiy";
	/**
	 * A short description.
	 */
	...
	public static final List<String> APP_EXTRA_CREDITS = Arrays.asList(//
			"Console Colors by \"shakram02\" @ stackoverflow.com"
			/* "Graphics by Foo Bar" */
			);
	/**
