package sem1.inf101.v18.rogue101;
...
import sem1.inf101.v18.gfx.textmode.TextMode;
...
public class Main extends Application {
	...
	public static final TextMode MAIN_TEXT_MODE = TextMode.MODE_80X30;

	public static final boolean DEBUG_TIME = false;

	public static final int LINE_MAP_BOTTOM = 19;
	public static final int LINE_STATUS = 20;
	public static final int LINE_MSG1 = 21;
	public static final int LINE_MSG2 = 22;
	public static final int LINE_MSG3 = 23;
	public static final int LINE_MSG4 = 24;
	public static final int LINE_MSG5 = 25;
	public static final int LINE_MSG6 = 26;
	public static final int LINE_MSG7 = 27;
	public static final int LINE_MSG8 = 28;
	public static final int LINE_MSGBOTTOM = 29;
	public static final int LINE_DEBUG = 30;
	...
	public void doTurn() {
		...
		if (!waitForPlayer)
			bigStepTimeline.playFromStart(); // this will kickstart a new turn in a few milliseconds
	}
	...
	public static String BUILTIN_MAP = "40 20\n"		   //
			...
			// smaller labyrinth for testing purposes
			/*"40 20\n" //
			+ "##########\n" //
			+ "#@#C  ####\n" //
			+ "#.#,#  ###\n" //
