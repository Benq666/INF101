 ...
 * {@link IPlayer#keyPressed(IGame, KeyCode)} or {@link INonPlayer#doTurn(IGame)} method.
 * 
 * @author anya
 *
 */
public interface IGame {
	...
	/**
	 * Set number of moves current actor can perform
	 */
	void setNumOfMoves(int numMoves);
